...
This individualistic way of consuming media unravels communities, but there are plenty of alternatives. By tracing the origins of video to cinema and cine-clubs, we can learn a lot about collective ways of curating and consuming content while also opening up for a process of reflection. This sort of experience enables different perspectives to be shared through an educational process, which can be much more fun than consuming content alone. All that’s required is a projector (or large screen), an open space for people to gather, and some resources on how to organize the screenings.
